...
-- BPMN Diagram Database Implementation (English Version)
-- ============================================================
...
CREATE TABLE staffing_requests (
    ...
    status VARCHAR(30) NOT NULL DEFAULT 'new' CHECK (status IN (
        'new', 'under_review', 'executor_assigned', 
        'in_progress', 'pending_approval', 'completed', 'closed', 'rejected'
    )),
...
-- Директора магазинов
('EMP-001', 'Ivan', 'Petrov', 'Sergeevich', 'i.petrov@company.ru', '+79001112233', 9, 1, '2019-03-15', TRUE),
('EMP-002', 'Maria', 'Sidorova', 'Alexandrovna', 'm.sidorova@company.ru', '+79002223344', 9, 2, '2020-06-01', TRUE),
...
('EMP-012', 'Pavel', 'Popov', 'Viktorovich', 'p.popov@company.ru', '+79020022334', 1, 3, '2022-01-10', TRUE),
-- Кассиры
('EMP-013', 'Viktoria', 'Smirnova', 'Alexandrovna', 'v.smirnova@company.ru', '+79012233445', 3, 1, '2020-08-25', TRUE),
('EMP-014', 'Artem', 'Fedorov', 'Sergeevich', 'a.fedorov@company.ru', '+79013344556', 3, 2, '2021-03-10', TRUE),
-- Товароведы
...
('REQ-2024-001', 1, 1, 1, 1, 2, 'small', 'Electronics department expansion', 'Two sales consultants needed for electronics department due to assortment expansion', 'Knowledge of home appliances and electronics; sales experience from 1 year', '2024-02-01', 'completed', 5, '2024-01-15 10:30:00', '2024-01-22 10:30:00', '2024-01-10 10:30:00'),
('REQ-2024-002', 2, 2, 2, 3, 1, 'small', 'Employee resignation', 'Cashier replacement due to voluntary resignation', 'Cashier experience; attention to detail; responsibility', '2024-02-15', 'closed', 6, '2024-01-20 09:00:00', '2024-01-24 09:00:00', '2024-01-18 09:00:00'),
('REQ-2024-003', 3, 3, 7, 1, 1, 'small', 'Employee illness', 'Urgent replacement of salesperson during sick leave', 'Ready to start within days', '2024-01-22', 'completed', 5, '2024-01-21 16:00:00', '2024-01-22 16:00:00', '2024-01-21 14:30:00'),
('REQ-2024-004', 1, 1, 4, 13, 3, 'medium', 'Inventory preparation', 'Additional staff for annual inventory preparation', 'Physical endurance; attention to detail', '2024-02-10', 'completed', 6, '2024-01-28 11:00:00', '2024-02-05 11:00:00', '2024-01-25 11:00:00'),
('REQ-2024-005', 4, 4, 1, 2, 1, 'small', 'New department opening', 'Senior salesperson needed for new cosmetics department', 'Cosmetics experience; management skills', '2024-03-01', 'executor_assigned', 7, '2024-02-01 10:00:00', '2024-02-15 10:00:00', '2024-01-30 10:00:00'),
('REQ-2024-006', 5, 1, 3, 3, 2, 'small', 'Vacation period', 'Temporary replacement of two cashiers during vacation period', 'Cashier experience; flexible schedule', '2024-02-20', 'in_progress', 5, '2024-02-03 14:00:00', '2024-02-07 14:00:00', '2024-02-01 14:00:00'),
('REQ-2024-007', 6, 3, 8, 1, 5, 'medium', 'Second floor opening', 'Staff expansion due to second floor opening', 'Retail experience; willingness to learn', '2024-04-01', 'under_review', NULL, NULL, '2024-03-15 10:00:00', '2024-02-05 09:00:00'),
('REQ-2024-008', 2, 2, 5, 4, 1, 'small', 'Transfer from another store', 'Administrator transfer from store MOW-001', 'Employee consent; administrator experience', '2024-03-01', 'completed', 6, '2024-02-08 12:00:00', '2024-02-15 12:00:00', '2024-02-05 12:00:00'),
('REQ-2024-009', 7, 4, 6, 1, 3, 'medium', 'New employee training', 'Request for onboarding program for new salespersons', 'Training skills; standards knowledge', '2024-03-15', 'completed', 7, '2024-02-12 10:00:00', '2024-02-26 10:00:00', '2024-02-10 10:00:00'),
('REQ-2024-010', 8, 1, 7, 14, 2, 'medium', 'Urgent need', 'Urgent hiring of loaders due to increased deliveries', 'Physical endurance; responsibility', '2024-02-15', 'completed', 5, '2024-02-14 08:00:00', '2024-02-15 20:00:00', '2024-02-14 06:00:00'),
('REQ-2024-011', 3, 3, 2, 5, 1, 'small', 'Maternity leave replacement', 'Merchandiser replacement during maternity leave', 'Merchandiser experience; 1C knowledge', '2024-03-01', 'in_progress', 6, '2024-02-18 11:00:00', '2024-02-22 11:00:00', '2024-02-15 11:00:00'),
('REQ-2024-012', 9, 2, 4, 1, 4, 'medium', 'Seasonal rush', 'Additional salespersons for spring season', 'Weekend availability; communication skills', '2024-03-01', 'new', NULL, NULL, '2024-02-28 10:00:00', '2024-02-18 10:00:00'),
('REQ-2024-013', 10, 4, 1, 6, 1, 'small', 'Volume growth', 'Warehouse manager needed due to increased turnover', 'Warehouse management experience; logistics knowledge', '2024-04-01', 'pending_approval', 7, '2024-02-20 14:00:00', '2024-02-27 14:00:00', '2024-02-19 14:00:00'),
('REQ-2024-014', 1, 1, 10, NULL, 0, 'small', 'Schedule optimization', 'Request to change work schedules for grocery department', 'Consent of all department employees', '2024-03-01', 'completed', 5, '2024-02-22 09:00:00', '2024-02-25 09:00:00', '2024-02-20 09:00:00'),
('REQ-2024-015', 11, 3, 3, 15, 1, 'small', 'Sick leave', 'Temporary replacement of security guard', 'Security guard license required', '2024-02-28', 'completed', 6, '2024-02-25 10:00:00', '2024-02-26 10:00:00', '2024-02-24 22:00:00'),
('REQ-2024-016', 4, 4, 9, 2, 1, 'small', 'Staff optimization', 'Reduction of one senior salesperson position', 'Compliance with reduction procedure', '2024-05-01', 'under_review', NULL, NULL, '2024-03-10 10:00:00', '2024-02-26 10:00:00'),
('REQ-2024-017', 12, 1, 7, 13, 2, 'medium', 'Emergency situation', 'Urgent replacement of storekeepers due to warehouse accident', 'Warehouse experience; night shift availability', '2024-02-28', 'completed', 5, '2024-02-27 07:00:00', '2024-02-28 07:00:00', '2024-02-27 05:30:00'),
('REQ-2024-018', 5, 2, 1, 11, 1, 'small', 'New project', 'Marketing specialist needed for loyalty program launch', 'Loyalty program experience; analytics', '2024-04-15', 'new', NULL, NULL, '2024-03-20 10:00:00', '2024-02-28 10:00:00');
...
(1, 1, 1, 'Request Created', NULL, 'new', 'Request created by store director', 1, '2024-01-10 10:30:00', 'Staff expansion request'),
(1, 1, 1, 'Executor Assigned', 'new', 'executor_assigned', 'Request assigned to HR specialist Olga Morozova', 5, '2024-01-15 10:30:00', 'Responsible assigned'),
(1, 1, 1, 'Completed', 'in_progress', 'completed', '2 candidates found and hired', 5, '2024-01-20 15:00:00', 'Request completed on time'),
(2, 2, 2, 'Request Created', NULL, 'new', 'Cashier replacement request', 2, '2024-01-18 09:00:00', 'Urgent replacement'),
(2, 2, 2, 'Executor Assigned', 'new', 'executor_assigned', 'Assigned to HR specialist Dmitry Volkov', 6, '2024-01-20 09:00:00', 'Executor assigned'),
(2, 2, 2, 'Closed', 'completed', 'closed', 'Candidate started work', 8, '2024-01-25 14:00:00', 'Closed by director'),
(3, 3, 3, 'Request Created', NULL, 'new', 'Urgent replacement due to illness', 3, '2024-01-21 14:30:00', 'Emergency request'),
(3, 3, 3, 'Executor Assigned', 'new', 'executor_assigned', 'Urgent assignment', 5, '2024-01-21 16:00:00', 'Within 1.5 hours'),
(4, 1, 1, 'Request Created', NULL, 'new', 'Additional staff request', 1, '2024-01-25 11:00:00', 'Inventory preparation'),
(4, 1, 1, 'Executor Assigned', 'new', 'executor_assigned', 'Responsible assigned', 6, '2024-01-28 11:00:00', ''),
(5, 4, 4, 'Request Created', NULL, 'new', 'Senior salesperson request', 4, '2024-01-30 10:00:00', 'New department'),
(5, 4, 4, 'Accepted for Review', 'new', 'under_review', 'Request forwarded for review', 8, '2024-01-31 10:00:00', ''),
(5, 4, 4, 'Executor Assigned', 'under_review', 'executor_assigned', 'HR specialist assigned', 7, '2024-02-01 10:00:00', ''),
(6, 5, 1, 'Request Created', NULL, 'new', 'Temporary replacement during vacation period', 1, '2024-02-01 14:00:00', ''),
(6, 5, 1, 'Work Started', 'executor_assigned', 'in_progress', 'Candidate search started', 5, '2024-02-03 14:00:00', ''),
(10, 8, 1, 'Request Created', NULL, 'new', 'Urgent loader hiring', 1, '2024-02-14 06:00:00', 'Emergency situation'),
(10, 8, 1, 'Executor Assigned', 'new', 'executor_assigned', 'Immediate assignment', 5, '2024-02-14 08:00:00', 'Response within 2 hours'),
(17, 12, 1, 'Request Created', NULL, 'new', 'Emergency replacement', 1, '2024-02-27 05:30:00', 'Night situation'),
(17, 12, 1, 'Executor Assigned', 'new', 'executor_assigned', 'Emergency assignment', 5, '2024-02-27 07:00:00', 'Response within 1.5 hours'),
(17, 12, 1, 'Completed', 'in_progress', 'completed', 'Employees found and started work', 5, '2024-02-28 06:00:00', 'Request completed');
...
(1, 1, 1, 'small', '2024-01-10 10:30:00', '2024-01-15 10:30:00', '2024-01-20 15:00:00', '2024-01-21 10:00:00', 120.00, 242.50, 263.50, 72, TRUE, 0, NULL),
(2, 2, 2, 'small', '2024-01-18 09:00:00', '2024-01-20 09:00:00', '2024-01-24 12:00:00', '2024-01-25 14:00:00', 48.00, 102.00, 149.00, 48, TRUE, 0, NULL),
(3, 3, 7, 'small', '2024-01-21 14:30:00', '2024-01-21 16:00:00', '2024-01-22 08:00:00', '2024-01-22 10:00:00', 1.50, 16.00, 17.50, 24, TRUE, 0, NULL),
(4, 1, 4, 'medium', '2024-01-25 11:00:00', '2024-01-28 11:00:00', '2024-02-05 16:00:00', '2024-02-06 10:00:00', 72.00, 261.00, 291.00, 96, TRUE, 0, NULL),
(5, 4, 1, 'small', '2024-01-30 10:00:00', '2024-02-01 10:00:00', NULL, NULL, 48.00, NULL, NULL, 72, TRUE, 0, NULL),
(6, 5, 3, 'small', '2024-02-01 14:00:00', '2024-02-03 14:00:00', NULL, NULL, 48.00, NULL, NULL, 36, FALSE, 12, 'Delayed executor assignment'),
(7, 6, 8, 'medium', '2024-02-05 09:00:00', NULL, NULL, NULL, NULL, NULL, NULL, 336, TRUE, 0, NULL),
(8, 2, 5, 'small', '2024-02-05 12:00:00', '2024-02-08 12:00:00', '2024-02-14 16:00:00', '2024-02-15 10:00:00', 72.00, 151.00, 239.00, 168, TRUE, 0, NULL),
(9, 7, 6, 'medium', '2024-02-10 10:00:00', '2024-02-12 10:00:00', '2024-02-25 17:00:00', '2024-02-26 09:00:00', 48.00, 319.00, 383.00, 336, TRUE, 0, NULL),
(10, 8, 7, 'medium', '2024-02-14 06:00:00', '2024-02-14 08:00:00', '2024-02-15 18:00:00', '2024-02-16 09:00:00', 2.00, 36.00, 51.00, 36, TRUE, 0, NULL),
(11, 3, 2, 'small', '2024-02-15 11:00:00', '2024-02-18 11:00:00', NULL, NULL, 72.00, NULL, NULL, 48, FALSE, 24, 'Extended candidate search'),
(14, 1, 10, 'small', '2024-02-20 09:00:00', '2024-02-22 09:00:00', '2024-02-24 17:00:00', '2024-02-25 10:00:00', 48.00, 77.00, 97.00, 72, TRUE, 0, NULL),
(15, 11, 3, 'small', '2024-02-24 22:00:00', '2024-02-25 10:00:00', '2024-02-26 08:00:00', '2024-02-26 10:00:00', 12.00, 34.00, 36.00, 36, TRUE, 0, NULL),
(17, 12, 7, 'medium', '2024-02-27 05:30:00', '2024-02-27 07:00:00', '2024-02-28 06:00:00', '2024-02-28 10:00:00', 1.50, 24.50, 28.50, 36, TRUE, 0, NULL),
(18, 5, 1, 'small', '2024-02-28 10:00:00', NULL, NULL, NULL, NULL, NULL, NULL, 96, TRUE, 0, NULL);
...
('TASK-2024-001', 1, 5, 3, '2024-01-22 10:30:00', 'Recruitment', 'Hiring 2 sales consultants for Alexeevsky store', '["Post vacancy", "Screen resumes", "Schedule interviews", "Verify documents", "Process hiring"]', 'completed', TRUE, TRUE, '2024-01-15 10:30:00'),
('TASK-2024-002', 2, 6, 2, '2024-01-24 09:00:00', 'Employee Replacement', 'Cashier hiring to replace resigned employee', '["Post vacancy", "Candidate screening", "Interview", "Processing"]', 'completed', TRUE, TRUE, '2024-01-20 09:00:00'),
('TASK-2024-003', 3, 5, 1, '2024-01-22 16:00:00', 'Urgent Replacement', 'Urgent salesperson replacement for sick leave', '["Check available database", "Contact candidate", "Confirm shift"]', 'completed', TRUE, TRUE, '2024-01-21 16:00:00'),
('TASK-2024-004', 4, 6, 3, '2024-02-05 11:00:00', 'Temporary Staff Hiring', 'Hiring 3 storekeepers for inventory', '["Analyze needs", "Find candidates", "Processing"]', 'completed', TRUE, TRUE, '2024-01-28 11:00:00'),
('TASK-2024-005', 5, 7, 3, '2024-02-15 10:00:00', 'Recruitment', 'Senior salesperson hiring for cosmetics department', '["Post vacancy", "Resume screening", "Interviews"]', 'in_progress', TRUE, TRUE, '2024-02-01 10:00:00'),
('TASK-2024-006', 6, 5, 2, '2024-02-07 14:00:00', 'Temporary Replacement', 'Hiring 2 cashiers for vacation period', '["Check database", "Schedule coordination"]', 'in_progress', TRUE, TRUE, '2024-02-03 14:00:00'),
('TASK-2024-007', 7, 6, 4, '2024-03-15 10:00:00', 'Mass Recruitment', 'Hiring 5 salespersons for new floor', '["Market analysis", "Mass selection", "Training"]', 'new', NULL, NULL, '2024-02-05 09:00:00'),
('TASK-2024-008', 8, 6, 4, '2024-02-15 12:00:00', 'Employee Transfer', 'Coordinator for administrator transfer between stores', '["Coordinate with directors", "Process transfer"]', 'completed', TRUE, TRUE, '2024-02-08 12:00:00'),
('TASK-2024-009', 9, 7, 4, '2024-02-26 10:00:00', 'Training', 'Onboarding program for new salespersons', '["Prepare program", "Assign mentors"]', 'completed', TRUE, TRUE, '2024-02-12 10:00:00'),
('TASK-2024-010', 10, 5, 1, '2024-02-15 20:00:00', 'Urgent Recruitment', 'Urgent hiring of 2 loaders', '["Emergency calls", "Processing"]', 'completed', TRUE, TRUE, '2024-02-14 08:00:00'),
('TASK-2024-011', 11, 6, 2, '2024-02-22 11:00:00', 'Maternity Leave Replacement', 'Merchandiser hiring for maternity leave coverage', '["Find candidates", "Interviews"]', 'in_progress', TRUE, TRUE, '2024-02-18 11:00:00'),
('TASK-2024-012', 12, 5, 3, '2024-02-28 10:00:00', 'Seasonal Recruitment', 'Hiring 4 salespersons for spring season', '["Post vacancies", "Candidate screening"]', 'new', NULL, NULL, '2024-02-18 10:00:00'),
('TASK-2024-013', 13, 7, 3, '2024-02-27 14:00:00', 'Recruitment', 'Warehouse manager hiring', '["Analyze requirements", "Find candidates"]', 'in_progress', TRUE, TRUE, '2024-02-20 14:00:00'),
('TASK-2024-014', 15, 6, 2, '2024-02-26 10:00:00', 'Temporary Replacement', 'Security guard replacement for sick leave', '["Find licensed guard", "Processing"]', 'completed', TRUE, TRUE, '2024-02-25 10:00:00'),
('TASK-2024-015', 17, 5, 1, '2024-02-28 07:00:00', 'Emergency Replacement', 'Urgent replacement of 2 storekeepers', '["Emergency search", "Start work"]', 'completed', TRUE, TRUE, '2024-02-27 07:00:00');
...
(8, 'Assignment Delay', 'Executor assignment time exceeded', 'Request REQ-2024-006 has been without executor assignment for over 48 hours. Intervention required.', 6, FALSE, '2024-02-05 14:00:00', 1),
(8, 'SLA Violation', 'Target SLA time exceeded', 'Request REQ-2024-011 has exceeded target response time. Take action.', 11, FALSE, '2024-02-20 11:00:00', 2),
(1, 'Request Status', 'Request completed', 'Your request REQ-2024-001 has been successfully completed. 2 employees hired.', 1, TRUE, '2024-01-20 15:00:00', 3),
(2, 'Request Status', 'Request closed', 'Request REQ-2024-002 is closed. Candidate started work.', 2, TRUE, '2024-01-25 14:00:00', 3),
(3, 'Request Status', 'Executor assigned', 'Your request REQ-2024-003 has an assigned executor. Expect results.', 3, TRUE, '2024-01-21 16:00:00', 2),
(5, 'New Task', 'New task assigned', 'Task TASK-2024-005 assigned to you. Deadline: Feb 15, 2024', 5, TRUE, '2024-02-01 10:00:00', 3),
(6, 'New Task', 'New task assigned', 'Task TASK-2024-006 assigned to you. Deadline: Feb 07, 2024', 6, TRUE, '2024-02-03 14:00:00', 2),
(7, 'New Task', 'New task assigned', 'Task TASK-2024-007 assigned to you. Large recruitment request.', 7, TRUE, '2024-02-05 09:00:00', 4),
(8, 'Information', 'Approval required', 'Request REQ-2024-007 requires approval for staff expansion.', 7, FALSE, '2024-02-06 10:00:00', 3),
(1, 'Request Status', 'Request in progress', 'Your request REQ-2024-004: staff recruitment has started.', 4, TRUE, '2024-01-28 11:00:00', 3),
(4, 'Request Status', 'Executor assigned', 'Request REQ-2024-005 has an assigned HR specialist. Recruitment started.', 5, TRUE, '2024-02-01 10:00:00', 3),
(5, 'Reminder', 'Deadline approaching', 'Task TASK-2024-005 deadline expires in 3 days.', 5, FALSE, '2024-02-12 10:00:00', 2),
(8, 'Report', 'Weekly report ready', 'Weekly request processing metrics report is available for review.', NULL, FALSE, '2024-02-19 09:00:00', 4),
(1, 'Urgent', 'Emergency request', 'Urgent request REQ-2024-017 created. Immediate response required.', 17, TRUE, '2024-02-27 05:30:00', 1),
(8, 'Information', 'New reduction request', 'Request REQ-2024-016 for staff reduction requires review.', 16, FALSE, '2024-02-26 11:00:00', 3);

-- Вставка журнала статусов - 18 записей
INSERT INTO request_status_log (request_id, status, changed_by, changed_at, comment) VALUES
(1, 'new', 1, '2024-01-10 10:30:00', 'Request created'),
(1, 'executor_assigned', 5, '2024-01-15 10:30:00', 'HR specialist assigned as responsible'),
(1, 'in_progress', 5, '2024-01-16 09:00:00', 'Candidate search started'),
(1, 'completed', 5, '2024-01-20 15:00:00', 'Candidates found and hired'),
(2, 'new', 2, '2024-01-18 09:00:00', 'Request created'),
(2, 'executor_assigned', 6, '2024-01-20 09:00:00', 'HR specialist assigned'),
(2, 'completed', 6, '2024-01-24 12:00:00', 'Candidate found and started work'),
(2, 'closed', 8, '2024-01-25 14:00:00', 'Request closed by central office manager'),
(3, 'new', 3, '2024-01-21 14:30:00', 'Urgent request created'),
(3, 'executor_assigned', 5, '2024-01-21 16:00:00', 'Emergency assignment'),
(3, 'completed', 5, '2024-01-22 08:00:00', 'Replacement found in shortest time'),
(5, 'new', 4, '2024-01-30 10:00:00', 'Request created'),
(5, 'under_review', 8, '2024-01-31 10:00:00', 'Forwarded for review'),
(5, 'executor_assigned', 7, '2024-02-01 10:00:00', 'Responsible assigned'),
(6, 'new', 1, '2024-02-01 14:00:00', 'Request created'),
(6, 'executor_assigned', 5, '2024-02-03 14:00:00', 'Assigned as executor'),
(6, 'in_progress', 5, '2024-02-04 09:00:00', 'Temporary employee search started'),
(17, 'completed', 5, '2024-02-28 06:00:00', 'Emergency situation resolved');
