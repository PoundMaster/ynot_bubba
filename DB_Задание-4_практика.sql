...
-- BPMN Diagram Database Implementation
-- ============================================================
...
CREATE TABLE staffing_requests (
    ...
    status VARCHAR(30) NOT NULL DEFAULT 'новый' CHECK (status IN (
        'новый', 'на_рассмотрении', 'назначен_исполнитель', 
        'в_работе', 'на_согласовании', 'выполнен', 'закрыт', 'отклонён'
    )),
...
CREATE TABLE auto_generated_tasks (
    ...
    description TEXT NOT NULL,
    checklist JSONB,
    status VARCHAR(30) NOT NULL DEFAULT 'новая' CHECK (status IN (
        'новая', 'принята', 'в_работе', 'выполнена', 'отменена'
    )),
...
-- Представление: История запросов для Store Manager
...
-- Возможный дубль - тот же человек в другом магазине (тот же email)
('EMP-012', 'Павел', 'Попов', 'Викторович', 'p.popov@company.ru', '+79020022334', 1, 3, '2022-01-10', TRUE),
-- Кассиры
...
('REQ-2024-001', 1, 1, 1, 1, 2, 'малый', 'Расширение отдела электроники', 'Требуются два продавца-консультанта в отдел электроники в связи с расширением ассортимента', 'Знание бытовой техники и электроники; опыт продаж от 1 года', '2024-02-01', 'выполнен', 5, '2024-01-15 10:30:00', '2024-01-22 10:30:00', '2024-01-10 10:30:00'),
('REQ-2024-002', 2, 2, 2, 3, 1, 'малый', 'Увольнение сотрудника', 'Замена кассира в связи с увольнением по собственному желанию', 'Опыт работы на кассе; внимательность; ответственность', '2024-02-15', 'закрыт', 6, '2024-01-20 09:00:00', '2024-01-24 09:00:00', '2024-01-18 09:00:00'),
('REQ-2024-003', 3, 3, 7, 1, 1, 'малый', 'Болезнь сотрудника', 'Срочная замена продавца на время больничного', 'Готовность к выходу в ближайшие дни', '2024-01-22', 'выполнен', 5, '2024-01-21 16:00:00', '2024-01-22 16:00:00', '2024-01-21 14:30:00'),
('REQ-2024-004', 1, 1, 4, 13, 3, 'средний', 'Подготовка к инвентаризации', 'Дополнительный персонал для подготовки к годовой инвентаризации', 'Физическая выносливость; внимательность', '2024-02-10', 'выполнен', 6, '2024-01-28 11:00:00', '2024-02-05 11:00:00', '2024-01-25 11:00:00'),
('REQ-2024-005', 4, 4, 1, 2, 1, 'малый', 'Открытие нового отдела', 'Требуется старший продавец в новый отдел косметики', 'Опыт работы с косметикой; навыки управления', '2024-03-01', 'назначен_исполнитель', 7, '2024-02-01 10:00:00', '2024-02-15 10:00:00', '2024-01-30 10:00:00'),
('REQ-2024-006', 5, 1, 3, 3, 2, 'малый', 'Отпускной период', 'Временная замена двух кассиров на время отпусков', 'Опыт работы на кассе; гибкий график', '2024-02-20', 'в_работе', 5, '2024-02-03 14:00:00', '2024-02-07 14:00:00', '2024-02-01 14:00:00'),
('REQ-2024-007', 6, 3, 8, 1, 5, 'средний', 'Открытие второго этажа', 'Расширение штата в связи с открытием второго этажа магазина', 'Опыт в рознице; готовность к обучению', '2024-04-01', 'на_рассмотрении', NULL, NULL, '2024-03-15 10:00:00', '2024-02-05 09:00:00'),
('REQ-2024-008', 2, 2, 5, 4, 1, 'малый', 'Перевод из другого магазина', 'Перевод администратора из магазина MOW-001', 'Согласие сотрудника; опыт работы администратором', '2024-03-01', 'выполнен', 6, '2024-02-08 12:00:00', '2024-02-15 12:00:00', '2024-02-05 12:00:00'),
('REQ-2024-009', 7, 4, 6, 1, 3, 'средний', 'Обучение новых сотрудников', 'Запрос на программу адаптации для новых продавцов', 'Навыки обучения; знание стандартов', '2024-03-15', 'выполнен', 7, '2024-02-12 10:00:00', '2024-02-26 10:00:00', '2024-02-10 10:00:00'),
('REQ-2024-010', 8, 1, 7, 14, 2, 'средний', 'Срочная потребность', 'Срочный набор грузчиков в связи с увеличением поставок', 'Физическая выносливость; ответственность', '2024-02-15', 'выполнен', 5, '2024-02-14 08:00:00', '2024-02-15 20:00:00', '2024-02-14 06:00:00'),
('REQ-2024-011', 3, 3, 2, 5, 1, 'малый', 'Декретная ставка', 'Замена товароведа на время декретного отпуска', 'Опыт работы товароведом; знание 1С', '2024-03-01', 'в_работе', 6, '2024-02-18 11:00:00', '2024-02-22 11:00:00', '2024-02-15 11:00:00'),
('REQ-2024-012', 9, 2, 4, 1, 4, 'средний', 'Сезонный наплыв', 'Дополнительные продавцы на весенний сезон', 'Готовность к работе в выходные; коммуникабельность', '2024-03-01', 'новый', NULL, NULL, '2024-02-28 10:00:00', '2024-02-18 10:00:00'),
('REQ-2024-013', 10, 4, 1, 6, 1, 'малый', 'Рост объёмов', 'Требуется заведующий складом в связи с ростом товарооборота', 'Опыт управления складом; знание складской логистики', '2024-04-01', 'на_согласовании', 7, '2024-02-20 14:00:00', '2024-02-27 14:00:00', '2024-02-19 14:00:00'),
('REQ-2024-014', 1, 1, 10, NULL, 0, 'малый', 'Оптимизация графиков', 'Запрос на изменение графиков работы отдела бакалеи', 'Согласие всех сотрудников отдела', '2024-03-01', 'выполнен', 5, '2024-02-22 09:00:00', '2024-02-25 09:00:00', '2024-02-20 09:00:00'),
('REQ-2024-015', 11, 3, 3, 15, 1, 'малый', 'Больничный', 'Временная замена охранника', 'Наличие лицензии охранника', '2024-02-28', 'выполнен', 6, '2024-02-25 10:00:00', '2024-02-26 10:00:00', '2024-02-24 22:00:00'),
('REQ-2024-016', 4, 4, 9, 2, 1, 'малый', 'Оптимизация штата', 'Сокращение одной штатной единицы старшего продавца', 'Соблюдение процедуры сокращения', '2024-05-01', 'на_рассмотрении', NULL, NULL, '2024-03-10 10:00:00', '2024-02-26 10:00:00'),
('REQ-2024-017', 12, 1, 7, 13, 2, 'средний', 'Аварийная ситуация', 'Срочная замена кладовщиков в связи с аварией на складе', 'Опыт работы на складе; готовность к ночным сменам', '2024-02-28', 'выполнен', 5, '2024-02-27 07:00:00', '2024-02-28 07:00:00', '2024-02-27 05:30:00'),
('REQ-2024-018', 5, 2, 1, 11, 1, 'малый', 'Новый проект', 'Требуется маркетолог для запуска программы лояльности', 'Опыт работы с программами лояльности; аналитика', '2024-04-15', 'новый', NULL, NULL, '2024-03-20 10:00:00', '2024-02-28 10:00:00');
...
(1, 1, 1, 'Создание запроса', NULL, 'новый', 'Запрос создан директором магазина', 1, '2024-01-10 10:30:00', 'Запрос на расширение штата'),
(1, 1, 1, 'Назначение исполнителя', 'новый', 'назначен_исполнитель', 'Запрос назначен HR-специалисту Ольге Морозовой', 5, '2024-01-15 10:30:00', 'Назначен ответственный'),
(1, 1, 1, 'Завершение', 'в_работе', 'выполнен', 'Подобраны 2 кандидата, приняты на работу', 5, '2024-01-20 15:00:00', 'Запрос выполнен в срок'),
(2, 2, 2, 'Создание запроса', NULL, 'новый', 'Запрос на замену кассира', 2, '2024-01-18 09:00:00', 'Срочная замена'),
(2, 2, 2, 'Назначение исполнителя', 'новый', 'назначен_исполнитель', 'Назначен HR-специалист Дмитрий Волков', 6, '2024-01-20 09:00:00', 'Исполнитель назначен'),
(2, 2, 2, 'Закрытие', 'выполнен', 'закрыт', 'Кандидат вышел на работу', 8, '2024-01-25 14:00:00', 'Закрыт директором'),
(3, 3, 3, 'Создание запроса', NULL, 'новый', 'Срочная замена по болезни', 3, '2024-01-21 14:30:00', 'Экстренный запрос'),
(3, 3, 3, 'Назначение исполнителя', 'новый', 'назначен_исполнитель', 'Срочное назначение', 5, '2024-01-21 16:00:00', 'В течение 1.5 часов'),
(4, 1, 1, 'Создание запроса', NULL, 'новый', 'Запрос на дополнительный персонал', 1, '2024-01-25 11:00:00', 'Подготовка к инвентаризации'),
(4, 1, 1, 'Назначение исполнителя', 'новый', 'назначен_исполнитель', 'Назначен ответственный', 6, '2024-01-28 11:00:00', ''),
(5, 4, 4, 'Создание запроса', NULL, 'новый', 'Запрос на старшего продавца', 4, '2024-01-30 10:00:00', 'Новый отдел'),
(5, 4, 4, 'Принятие в работу', 'новый', 'на_рассмотрении', 'Запрос передан на рассмотрение', 8, '2024-01-31 10:00:00', ''),
(5, 4, 4, 'Назначение исполнителя', 'на_рассмотрении', 'назначен_исполнитель', 'Назначен HR-специалист', 7, '2024-02-01 10:00:00', ''),
(6, 5, 1, 'Создание запроса', NULL, 'новый', 'Временная замена на период отпусков', 1, '2024-02-01 14:00:00', ''),
(6, 5, 1, 'Начало работы', 'назначен_исполнитель', 'в_работе', 'Подбор кандидатов начат', 5, '2024-02-03 14:00:00', ''),
(10, 8, 1, 'Создание запроса', NULL, 'новый', 'Срочный набор грузчиков', 1, '2024-02-14 06:00:00', 'Экстренная ситуация'),
(10, 8, 1, 'Назначение исполнителя', 'новый', 'назначен_исполнитель', 'Мгновенное назначение', 5, '2024-02-14 08:00:00', 'Реакция в течение 2 часов'),
(17, 12, 1, 'Создание запроса', NULL, 'новый', 'Аварийная замена', 1, '2024-02-27 05:30:00', 'Ночная ситуация'),
(17, 12, 1, 'Назначение исполнителя', 'новый', 'назначен_исполнитель', 'Экстренное назначение', 5, '2024-02-27 07:00:00', 'Реакция в течение 1.5 часов'),
(17, 12, 1, 'Завершение', 'в_работе', 'выполнен', 'Сотрудники найдены и выведены на работу', 5, '2024-02-28 06:00:00', 'Запрос выполнен');
...
(1, 1, 1, 'малый', '2024-01-10 10:30:00', '2024-01-15 10:30:00', '2024-01-20 15:00:00', '2024-01-21 10:00:00', 120.00, 242.50, 263.50, 72, TRUE, 0, NULL),
(2, 2, 2, 'малый', '2024-01-18 09:00:00', '2024-01-20 09:00:00', '2024-01-24 12:00:00', '2024-01-25 14:00:00', 48.00, 102.00, 149.00, 48, TRUE, 0, NULL),
(3, 3, 7, 'малый', '2024-01-21 14:30:00', '2024-01-21 16:00:00', '2024-01-22 08:00:00', '2024-01-22 10:00:00', 1.50, 16.00, 17.50, 24, TRUE, 0, NULL),
(4, 1, 4, 'средний', '2024-01-25 11:00:00', '2024-01-28 11:00:00', '2024-02-05 16:00:00', '2024-02-06 10:00:00', 72.00, 261.00, 291.00, 96, TRUE, 0, NULL),
(5, 4, 1, 'малый', '2024-01-30 10:00:00', '2024-02-01 10:00:00', NULL, NULL, 48.00, NULL, NULL, 72, TRUE, 0, NULL),
(6, 5, 3, 'малый', '2024-02-01 14:00:00', '2024-02-03 14:00:00', NULL, NULL, 48.00, NULL, NULL, 36, FALSE, 12, 'Задержка назначения исполнителя'),
(7, 6, 8, 'средний', '2024-02-05 09:00:00', NULL, NULL, NULL, NULL, NULL, NULL, 336, TRUE, 0, NULL),
(8, 2, 5, 'малый', '2024-02-05 12:00:00', '2024-02-08 12:00:00', '2024-02-14 16:00:00', '2024-02-15 10:00:00', 72.00, 151.00, 239.00, 168, TRUE, 0, NULL),
(9, 7, 6, 'средний', '2024-02-10 10:00:00', '2024-02-12 10:00:00', '2024-02-25 17:00:00', '2024-02-26 09:00:00', 48.00, 319.00, 383.00, 336, TRUE, 0, NULL),
(10, 8, 7, 'средний', '2024-02-14 06:00:00', '2024-02-14 08:00:00', '2024-02-15 18:00:00', '2024-02-16 09:00:00', 2.00, 36.00, 51.00, 36, TRUE, 0, NULL),
(11, 3, 2, 'малый', '2024-02-15 11:00:00', '2024-02-18 11:00:00', NULL, NULL, 72.00, NULL, NULL, 48, FALSE, 24, 'Длительный поиск кандидата'),
(14, 1, 10, 'малый', '2024-02-20 09:00:00', '2024-02-22 09:00:00', '2024-02-24 17:00:00', '2024-02-25 10:00:00', 48.00, 77.00, 97.00, 72, TRUE, 0, NULL),
(15, 11, 3, 'малый', '2024-02-24 22:00:00', '2024-02-25 10:00:00', '2024-02-26 08:00:00', '2024-02-26 10:00:00', 12.00, 34.00, 36.00, 36, TRUE, 0, NULL),
(17, 12, 7, 'средний', '2024-02-27 05:30:00', '2024-02-27 07:00:00', '2024-02-28 06:00:00', '2024-02-28 10:00:00', 1.50, 24.50, 28.50, 36, TRUE, 0, NULL),
(18, 5, 1, 'малый', '2024-02-28 10:00:00', NULL, NULL, NULL, NULL, NULL, NULL, 96, TRUE, 0, NULL);
...
('TASK-2024-001', 1, 5, 3, '2024-01-22 10:30:00', 'Подбор персонала', 'Подбор 2 продавцов-консультантов для магазина Алексеевский', '["Разместить вакансию", "Провести отбор резюме", "Назначить собеседования", "Проверить документы", "Оформить приём"]', 'выполнена', TRUE, TRUE, '2024-01-15 10:30:00'),
('TASK-2024-002', 2, 6, 2, '2024-01-24 09:00:00', 'Замена сотрудника', 'Подбор кассира на замену уволившемуся', '["Разместить вакансию", "Отбор кандидатов", "Собеседование", "Оформление"]', 'выполнена', TRUE, TRUE, '2024-01-20 09:00:00'),
('TASK-2024-003', 3, 5, 1, '2024-01-22 16:00:00', 'Срочная замена', 'Срочная замена продавца на больничный', '["Проверить базу доступных", "Связаться с кандидатом", "Подтвердить выход"]', 'выполнена', TRUE, TRUE, '2024-01-21 16:00:00'),
('TASK-2024-004', 4, 6, 3, '2024-02-05 11:00:00', 'Подбор временного персонала', 'Подбор 3 кладовщиков для инвентаризации', '["Анализ потребности", "Поиск кандидатов", "Оформление"]', 'выполнена', TRUE, TRUE, '2024-01-28 11:00:00'),
('TASK-2024-005', 5, 7, 3, '2024-02-15 10:00:00', 'Подбор персонала', 'Подбор старшего продавца в отдел косметики', '["Разместить вакансию", "Отбор резюме", "Собеседования"]', 'в_работе', TRUE, TRUE, '2024-02-01 10:00:00'),
('TASK-2024-006', 6, 5, 2, '2024-02-07 14:00:00', 'Временная замена', 'Подбор 2 кассиров на период отпусков', '["Проверка базы", "Согласование графиков"]', 'в_работе', TRUE, TRUE, '2024-02-03 14:00:00'),
('TASK-2024-007', 7, 6, 4, '2024-03-15 10:00:00', 'Массовый подбор', 'Подбор 5 продавцов для нового этажа', '["Анализ рынка", "Массовый отбор", "Обучение"]', 'новая', NULL, NULL, '2024-02-05 09:00:00'),
('TASK-2024-008', 8, 6, 4, '2024-02-15 12:00:00', 'Перевод сотрудника', 'Координация перевода администратора между магазинами', '["Согласование с директорами", "Оформление перевода"]', 'выполнена', TRUE, TRUE, '2024-02-08 12:00:00'),
('TASK-2024-009', 9, 7, 4, '2024-02-26 10:00:00', 'Обучение', 'Организация программы адаптации для новых продавцов', '["Подготовка программы", "Назначение наставников"]', 'выполнена', TRUE, TRUE, '2024-02-12 10:00:00'),
('TASK-2024-010', 10, 5, 1, '2024-02-15 20:00:00', 'Срочный подбор', 'Срочный набор 2 грузчиков', '["Экстренный обзвон", "Оформление"]', 'выполнена', TRUE, TRUE, '2024-02-14 08:00:00'),
('TASK-2024-011', 11, 6, 2, '2024-02-22 11:00:00', 'Замена на декрет', 'Подбор товароведа на декретную ставку', '["Поиск кандидатов", "Собеседования"]', 'в_работе', TRUE, TRUE, '2024-02-18 11:00:00'),
('TASK-2024-012', 12, 5, 3, '2024-02-28 10:00:00', 'Сезонный подбор', 'Подбор 4 продавцов на весенний сезон', '["Размещение вакансий", "Отбор кандидатов"]', 'новая', NULL, NULL, '2024-02-18 10:00:00'),
('TASK-2024-013', 13, 7, 3, '2024-02-27 14:00:00', 'Подбор персонала', 'Подбор заведующего складом', '["Анализ требований", "Поиск кандидатов"]', 'в_работе', TRUE, TRUE, '2024-02-20 14:00:00'),
('TASK-2024-014', 15, 6, 2, '2024-02-26 10:00:00', 'Временная замена', 'Замена охранника на больничный', '["Поиск лицензированного охранника", "Оформление"]', 'выполнена', TRUE, TRUE, '2024-02-25 10:00:00'),
('TASK-2024-015', 17, 5, 1, '2024-02-28 07:00:00', 'Аварийная замена', 'Срочная замена 2 кладовщиков', '["Экстренный поиск", "Вывод на работу"]', 'выполнена', TRUE, TRUE, '2024-02-27 07:00:00');
...
(8, 'Задержка назначения', 'Превышено время назначения исполнителя', 'По запросу REQ-2024-006 прошло более 48 часов без назначения исполнителя. Требуется вмешательство.', 6, FALSE, '2024-02-05 14:00:00', 1),
(8, 'Нарушение SLA', 'Нарушение целевого времени SLA', 'Запрос REQ-2024-011 превысил целевое время отклика. Принять меры.', 11, FALSE, '2024-02-20 11:00:00', 2),
(1, 'Статус запроса', 'Запрос выполнен', 'Ваш запрос REQ-2024-001 успешно выполнен. Подобрано 2 сотрудника.', 1, TRUE, '2024-01-20 15:00:00', 3),
(2, 'Статус запроса', 'Запрос закрыт', 'Запрос REQ-2024-002 закрыт. Кандидат вышел на работу.', 2, TRUE, '2024-01-25 14:00:00', 3),
(3, 'Статус запроса', 'Исполнитель назначен', 'По вашему запросу REQ-2024-003 назначен ответственный. Ожидайте результатов.', 3, TRUE, '2024-01-21 16:00:00', 2),
(5, 'Новое задание', 'Назначено новое задание', 'Вам назначено задание TASK-2024-005. Срок выполнения до 15.02.2024', 5, TRUE, '2024-02-01 10:00:00', 3),
(6, 'Новое задание', 'Назначено новое задание', 'Вам назначено задание TASK-2024-006. Срок выполнения до 07.02.2024', 6, TRUE, '2024-02-03 14:00:00', 2),
(7, 'Новое задание', 'Назначено новое задание', 'Вам назначено задание TASK-2024-007. Крупный запрос на подбор.', 7, TRUE, '2024-02-05 09:00:00', 4),
(8, 'Информация', 'Требуется согласование', 'Запрос REQ-2024-007 требует согласования для расширения штата.', 7, FALSE, '2024-02-06 10:00:00', 3),
(1, 'Статус запроса', 'Запрос в работе', 'По вашему запросу REQ-2024-004 начат подбор персонала.', 4, TRUE, '2024-01-28 11:00:00', 3),
(4, 'Статус запроса', 'Исполнитель назначен', 'По запросу REQ-2024-005 назначен HR-специалист. Начат подбор.', 5, TRUE, '2024-02-01 10:00:00', 3),
(5, 'Напоминание', 'Приближается срок', 'Срок выполнения задания TASK-2024-005 истекает через 3 дня.', 5, FALSE, '2024-02-12 10:00:00', 2),
(8, 'Отчёт', 'Еженедельный отчёт готов', 'Еженедельный отчёт по метрикам обработки запросов доступен для просмотра.', NULL, FALSE, '2024-02-19 09:00:00', 4),
(1, 'Срочно', 'Экстренный запрос', 'Создан срочный запрос REQ-2024-017. Требуется немедленная реакция.', 17, TRUE, '2024-02-27 05:30:00', 1),
(8, 'Информация', 'Новый запрос на расширение', 'Запрос REQ-2024-016 на сокращение штата требует рассмотрения.', 16, FALSE, '2024-02-26 11:00:00', 3);

-- Вставка журнала статусов - 18 записей
INSERT INTO request_status_log (request_id, status, changed_by, changed_at, comment) VALUES
(1, 'новый', 1, '2024-01-10 10:30:00', 'Запрос создан'),
(1, 'назначен_исполнитель', 5, '2024-01-15 10:30:00', 'Назначен ответственный HR-специалист'),
(1, 'в_работе', 5, '2024-01-16 09:00:00', 'Начат подбор кандидатов'),
(1, 'выполнен', 5, '2024-01-20 15:00:00', 'Подобраны кандидаты, приняты на работу'),
(2, 'новый', 2, '2024-01-18 09:00:00', 'Запрос создан'),
(2, 'назначен_исполнитель', 6, '2024-01-20 09:00:00', 'Назначен HR-специалист'),
(2, 'выполнен', 6, '2024-01-24 12:00:00', 'Кандидат найден и вышел на работу'),
(2, 'закрыт', 8, '2024-01-25 14:00:00', 'Запрос закрыт менеджером центрального офиса'),
(3, 'новый', 3, '2024-01-21 14:30:00', 'Срочный запрос создан'),
(3, 'назначен_исполнитель', 5, '2024-01-21 16:00:00', 'Экстренное назначение'),
(3, 'выполнен', 5, '2024-01-22 08:00:00', 'Замена найдена в кратчайшие сроки'),
(5, 'новый', 4, '2024-01-30 10:00:00', 'Запрос создан'),
(5, 'на_рассмотрении', 8, '2024-01-31 10:00:00', 'Передан на рассмотрение'),
(5, 'назначен_исполнитель', 7, '2024-02-01 10:00:00', 'Назначен ответственный'),
(6, 'новый', 1, '2024-02-01 14:00:00', 'Запрос создан'),
(6, 'назначен_исполнитель', 5, '2024-02-03 14:00:00', 'Назначен исполнителем'),
(6, 'в_работе', 5, '2024-02-04 09:00:00', 'Начат подбор временных сотрудников'),
(17, 'выполнен', 5, '2024-02-28 06:00:00', 'Экстренная ситуация разрешена');
...
COMMENT ON TABLE request_history IS 'История запросов для Store Manager (Data Object из BPMN)';
...
COMMENT ON TABLE response_presets IS 'Шаблоны ответов HR-специалиста (для развилки Assign Executor)';
...
-- Показать возможные дубли сотрудников
